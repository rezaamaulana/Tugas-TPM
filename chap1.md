...
>_Sejarah manusia sampai saat ini telah menunjukkan bahwa apapun cukup kompleks
...
— whether that means no censorship, rigid centralized control, selfregulation, or any other set of mechanisms — to be acceptable everywhere. And yet, Internet content is available everywhere and the way the network is organized makes it difficult to assign
...
— apakah itu berarti tidak ada penyensoran, kontrol terpusat yang kaku, pengaturan mandiri, atau serangkaian mekanisme lainnya — yang dapat diterima di mana-mana. Namun, konten Internet tersedia di mana-mana dan cara jaringan diatur membuatnya sulit untuk ditetapkan
...
>   - Pola yang mapan untuk penyensoran film, seperti yang dipraktikkan
di Inggris dan negara-negara lain dengan sistem serupa,
mencoba menggabungkan batasan pada penerimaan dengan beberapa kontrol
distribusi. Dalam kasus ekstrim, sensor dapat menolak sertifikasi,
secara efektif mencegah pemutaran film itu di sebagian besar tempat, atau
mereka mungkin memerlukan adegan untuk diedit sebelum sertifikat dapat
diberikan. Langkah-langkah ini mempengaruhi distribusi, tetapi dengan memberi label masing-masing
film yang 'lulus' dengan sertifikat yang menentukan kelompok usia berapa
dapat secara hukum diizinkan untuk menonton film itu, sensor juga berusaha
untuk mengontrol penerimaan — meskipun dalam praktiknya di Inggris, misalnya,
ini tidak diberlakukan dengan sangat ketat. Cacat yang signifikan dalam hal ini
sistem, yang telah ditangani oleh distributor pita video tertentu,
adalah bahwa tidak ada indikasi yang diberikan tentang sifat konten yang
dianggap tidak sesuai. Ini membuat sangat sulit bagi siapa pun
untuk menjalankan kontrol mereka sendiri atas apa yang mereka hadapi di
film, kecuali mereka memiliki akses ke informasi tentang level film
kekerasan, atau apa pun, dari sumber lain.
...
Deskripsi layanan PICS adalah dokumen yang menentukan format
...
different perspective by Brent MacGregor in his Afterword.

>## _**Informasi lebih lanjut**_
>
>_Beberapa masalah yang diangkat dalam bab ini diambil dari
perspektif berbeda oleh Brent MacGregor dalam Kata Penutupnya._

<br>
If you are interested in the cultural theory of multimedia, [Bar77]
...
of new technology on craftsmanship, and [Lis95] looks at digital mages. [RM96] is a short introduction to the mechanics of PICS.
...
>_Jika Anda tertarik dengan teori budaya multimedia, [Bar77]
...
teknologi baru pada keahlian, dan [Lis95] melihat penyihir digital. [RM96] adalah pengenalan singkat tentang mekanisme PICS.
...
>## _**Latihan**_
>
>_1. Apakah ide membuat film dari buku ini tidak masuk akal?_

2. The late Kingsley Amis reportedly once asserted that he would
never read another book unless it began A shot rang out!. How
would this opening be realized in

    - A radio play;
    - A stage play;
    - A film;
    - An animation;
    - A single created image;
    - A photograph;
    - A comic strip;
    - A song;
    - A symphony?

    If you have access to suitable facilities, produce a rough
version of each of your answers.

>_2. Almarhum Kingsley Amis dilaporkan pernah menegaskan bahwa dia akan
tidak pernah membaca buku lain kecuali jika dimulai Sebuah tembakan terdengar!. Bagaimana
apakah pembukaan ini akan terwujud dalam_
>- Sebuah drama radio;
>- Sebuah drama panggung;
>- Sebuah film;
>- Sebuah animasi;
>- Satu gambar yang dibuat;
>- Foto;
>- Komik strip;
>- Lagu;
>- Sebuah simfoni?
>
>_Jika Anda memiliki akses ke fasilitas yang sesuai, hasilkan yang kasar
versi masing-masing jawaban Anda._

3. A commonly used means of multimedia delivery is the information kiosk, a computer system with limited functionality
provided for the public to learn about, for example, the
exhibits in a museum, or tourist facilities in a city. Discuss
whether information kiosks are a qualitatively different form
of delivery from those described in this chapter.

>_3. Sarana penyampaian multimedia yang umum digunakan adalah kios informasi, sistem komputer dengan fungsi terbatas
disediakan bagi masyarakat untuk belajar tentang, misalnya,
pameran di museum, atau fasilitas wisata di kota. Membahas
apakah kios informasi adalah bentuk yang berbeda secara kualitatif
pengiriman dari yang dijelaskan dalam bab ini._

4. Choose a Web site and a multimedia CD-ROM available to
you. For each of them, identify at least five (and preferably
ten) ways in which you think it could be improved. State the
criteria you use to judge them by.

>_4. Pilih situs Web dan CD-ROM multimedia yang tersedia untuk
Anda. Untuk masing-masing dari mereka, mengidentifikasi setidaknya lima (dan sebaiknya
sepuluh) cara yang menurut Anda dapat ditingkatkan. Nyatakan
kriteria yang Anda gunakan untuk menilai mereka._

5. Look closely at the user interface of any application of your
choice, and identify ten features of that interface which you personally do not like. Explain the reasons for your choices,
and suggest possible improvements.

>_5. Perhatikan baik-baik antarmuka pengguna aplikasi apa pun dari Anda
pilihan, dan identifikasi sepuluh fitur antarmuka yang tidak Anda sukai secara pribadi. Jelaskan alasan pilihan Anda,
dan menyarankan kemungkinan perbaikan._

6. Choose a straightforward subject, such as a guide to guest
accommodation in your neighbourhood. Design a simple onepage layout of graphical material and text, which optimises
intelligibility and access to information for potential users of
all levels of ability.

>_6. Pilih subjek yang lugas, seperti panduan untuk tamu
akomodasi di lingkungan Anda. Rancang tata letak satu halaman sederhana dari materi grafis dan teks, yang mengoptimalkan
kejelasan dan akses ke informasi untuk pengguna potensial dari
semua tingkat kemampuan._

7. We stated on page 13 that 'ultimate control over "the content
and flow of information" remains with the producer not
the user'. Ignoring feasibility, discuss whether it would be
desirable for true control to be transferred to the user.

>_7. Kami menyatakan di halaman 13 bahwa 'kontrol penuh atas "konten"
dan arus informasi" tetap pada produsen tidak
pengguna'. Mengabaikan kelayakan, diskusikan apakah itu akan
diinginkan untuk kontrol yang benar untuk ditransfer ke pengguna._

8. If you are working within a group of people, have each
member of the group devise their own set of six filtering
labels, which they would choose to apply to a Web site of
their making for the guidance of users, and then compare and
discuss results. If you are in a position to do so, extend this
exercise to include other groups in other countries.

>_8. Jika Anda bekerja dalam sekelompok orang, mintalah masing-masing
anggota kelompok merancang set enam penyaringan mereka sendiri
label, yang akan mereka pilih untuk diterapkan ke situs Web
pembuatannya untuk panduan pengguna, dan kemudian membandingkan dan
mendiskusikan hasil. Jika Anda berada dalam posisi untuk melakukannya, perpanjang ini
latihan untuk memasukkan kelompok lain di negara lain._

9. A committed vegetarian couple wish to prevent their children
from being exposed to images of meat on the World Wide Web.
What difficulties would they face in using PICS ratings for this
purpose?

>_9. Pasangan vegetarian yang berkomitmen ingin mencegah anak-anak mereka
dari terpapar gambar daging di World Wide Web.
Kesulitan apa yang akan mereka hadapi dalam menggunakan peringkat PICS untuk ini?
tujuan?_